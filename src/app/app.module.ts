...
import { SearchMultiVillagesResultsComponent } from "./search-multi-villages-results/search-multi-villages-results.component";
...
@NgModule({
  declarations: [
    ...
    VillagesearchPipe,
    SearchMultiVillagesResultsComponent,
  ],
  imports: [
    HttpClientModule,
    ...
    RouterModule.forRoot([
      ...
      },
      {
        ...
        component: SearchMultiVillagesResultsComponent,
      },
