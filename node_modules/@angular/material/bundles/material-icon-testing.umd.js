(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/cdk/testing'), require('@angular/core'), require('@angular/material/icon'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@angular/material/icon/testing', ['@angular/core','exports', '@angular/cdk/testing', '@angular/core', '@angular/material/icon', 'rxjs'], factory) :
    (global = global || self, factory(global.ng.core,(global.ng = global.ng || {}, global.ng.material = global.ng.material || {}, global.ng.material.icon = global.ng.material.icon || {}, global.ng.material.icon.testing = {}), global.ng.cdk.testing, global.ng.core, global.ng.material.icon, global.rxjs));
}(this, (function (ɵngcc0,exports, testing, core, icon, rxjs) { 'use strict';
...
MatIconTestingModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function MatIconTestingModule_Factory(t) { return new (t || MatIconTestingModule)(); }, providers: [{ provide: icon.MatIconRegistry, useClass: FakeMatIconRegistry }] });
